...
<!-- 사이드 -->
        ...
        <article id = "postList">
        	<div id = "postList">
        		<section id = "title"><h1>게임게시판</h1></section>
        		...
        		<section id = "generalList">
        			...
        			<c:choose>
        			<c:when test="${memGrade == 2 && board.boardCategory==2 && board.delYn eq 'N'}">
        			<a href="boardlist?boardKey=${board.boardKey}&category=${2}" class="notice">
        					...
        					<div class="info">
        						<div class="title">
        							...
        							<div class="etc">
        							<div id="nickName">
        								<img src="resources/images/gameAdminIcon.png">
        								<div>${board.nName}</div>
        							</div>
        				...
        				<c:set var = "memGrade" value="${board.memGrade}"/>
        				<c:choose>
        				<c:when test="${memGrade == 1 && board.boardCategory==2 && board.delYn eq 'N'}">
