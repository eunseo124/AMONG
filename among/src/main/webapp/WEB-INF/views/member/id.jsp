		...
		$(function(){
		    $("#su").click(function(){
		        ...
		        $.ajax({
		            ...
		            url:"<c:url value='/member/idfind'/>" , // 컨트롤러로 가는 mapping 입력
		            data: {"memName":memName, "memEmail1":memEmail1, "memEmail2":memEmail2}, // 원하는 값을 중복확인하기위해서  JSON 형태로 DATA 전송
		            success: function(data){ 
		                if(data == 0){ // 만약 성공할시
		                	alert("아이디는 " + memId + "입니다.")
