            		...
            		<div class = "pmypage1" style="height:800px;">
            				<div class = "pmypage2" style="width:1000px;">
	                                ...
	                                <div class = "pheader2" role="tablist">
					            		...
					            		<div role="presentation"><h4><a href="mypost2?memKey=${sessionc.memKey}" id="ones" class="menu_ones" role="tab" aria-selected="false">인기 게시판</a></h4></div>
					            		<div role="presentation"><h4><a href="mypost3?memKey=${sessionc.memKey}" id="loinid" class="menu_id2" role="tab" aria-selected="false"> 게임 </a></h4></div>
					            		<div role="presentation"><h4><a href="mypost4?memKey=${sessionc.memKey}" id="loinid" class="menu_id3 on" role="tab" aria-selected="true"> 맛집 </a></h4></div>
					            		<div role="presentation"><h4><a href="mypost5?memKey=${sessionc.memKey}" id="loinid" class="menu_id4" role="tab" aria-selected="false"> 여행 </a></h4></div>
			            			</div>
                                	<div class="Htable" aria-controls="loinid">
	                                   ...
	                                   <input type="hidden" id="modifyDate" value="${boardl.boardModifyDate}">
	                                    ...
	                                    <div style = "display:flex; list-style:none;">
							                ...
							                <li>
							                    <a href='<c:url value="/mypost4?memKey=${param.memKey}&page=${pageMaker.startPage-1 }"/>'><i style = "list-decoration:none;">처음으로</i></a>
							                </li>
							                </c:if>
							                <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="pageNum">
							                <li>
							                    <a href='<c:url value="/mypost4?memKey=${param.memKey}&page=${pageNum }"/>'><i class="fa">${pageNum }</i></a>
							                </li>
							                </c:forEach>
							                <c:if test="${pageMaker.next && pageMaker.endPage >0 }">
							                <li>
							                    <a href='<c:url value="/mypost4?memKey=${param.memKey}&page=${pageMaker.endPage+1 }"/>'><i class="fa fa-chevron-right"></i></a>
							                </li>
							           </c:if>
							           </div>
                                </div>
